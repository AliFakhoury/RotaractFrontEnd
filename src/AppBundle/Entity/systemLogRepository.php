...
class systemLogRepository extends EntityRepository{
    ...
    public function addSystemLog($adminID, $affectedID, $tableName, $action, $ip){
        $conn = $this->getEntityManager()->getConnection();
        
        $sql = "INSERT INTO system_log(affected_id,table_name,action,admin_id, timestamp, ip) VALUES("."".$affectedID.",'".$tableName."','".$action."',".$adminID.",'".date('Y-m-d H:i:s',$_SERVER["REQUEST_TIME"]).
            "','".$ip."')";
